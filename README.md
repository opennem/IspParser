...
Verification charts comparing generation, capacity, and emissions across all ISP releases are published via GitHub Pages from [`output-reference/`](output-reference/).
